...
<AddTemplate templateName="Scanner">
    <form @submit.prevent="" class="space-y-4">
        <div class="grid grid-cols-2 gap-x-6">
            <TextField id="scanner_brand" labelFor="scanner_brand" fieldName="Brand: "/>

            <TextField id="scanner_model" labelFor="scanner_model" fieldName="Model: "/>

            <TextField id="scanner_serial_number" labelFor="scanner_serial_number" fieldName="Serial Number: "/>

            <TextField id="scanner_inventory_number" labelFor="scanner_inventory_number" fieldName="Inventory Number: "/>
            ...
            <div class="flex flex-row-reverse mb-6 group">
                <select id="scanner_status" :class="[option_field_class]" class="bg-white">
        ...
        <LocationOptions 
        id_ministry="scanner_ministry"

        id_division="scanner_division"

        id_section="scanner_section"

        id_location="scanner_location"
        />

        <CommentField id="scanner_comment" labelFor="scanner_comment" fieldName="Comment: "/>
